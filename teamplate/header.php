        ...
        <nav id="sidebar" class="bg-dark">
            ...
            <ul class="list-unstyled components">
                ...
                <div class="mt-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="pendidikan.php"><i class="fas fa-graduation-cap mr-3"></i>Data Pendidikan</a>
                        <hr class="bg-secondary">
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="pelatihan.php"><i class="fas fa-user-cog mr-3"></i>Data Pelatihan</a>
                        <hr class="bg-secondary">
                    </li>
                    <li class="nav-item">
